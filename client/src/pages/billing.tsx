...
import { CreditCard, Search, Plus, FileText, Mail, Filter, Eye, Receipt, Check, X, Clock, Image, Printer, Download } from "lucide-react";
            ...
            <div id="invoice-print-content" className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="font-medium">{selectedInvoice.client?.firstName} {selectedInvoice.client?.lastName}</p>
                ...
                <div className="text-right">
                  <div className="mb-2">
                    <h3 className="font-semibold text-sm text-muted-foreground">Fecha de Emisión</h3>
                  ...
                  {selectedInvoice.dueDate && (
                    <div>
                      <h3 className="font-semibold text-sm text-muted-foreground">Fecha de Vencimiento</h3>
                        ...
                        <body>
                          ...
                          <div class="grid">
                            <div>
                              ...
                              <p style="font-weight: 500;">${selectedInvoice?.client?.firstName || ''} ${selectedInvoice?.client?.lastName || ''}</p>
                              <p style="color: #6b7280; font-size: 14px;">${selectedInvoice?.client?.email || ''}</p>
                            </div>
                            <div style="text-align: right;">
                              <p style="color: #6b7280; font-size: 12px;">Fecha de Emisión</p>
                              <p>${selectedInvoice ? new Date(selectedInvoice.createdAt).toLocaleDateString('es-ES') : ''}</p>
                            </div>
                          </div>
                          <table>
                            <thead>
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td class="text-right">$${Number(selectedInvoice?.amount || 0).toLocaleString()}</td>
                                <td class="text-right">$${Number(selectedInvoice?.amount || 0).toLocaleString()}</td>
                              </tr>
                            </tbody>
                            <tfoot>
                              <tr class="total-row">
                                ...
                                <td class="text-right font-bold">$${Number(selectedInvoice?.amount || 0).toLocaleString()}</td>
                              </tr>
                            </tfoot>
                          </table>
                        </body>
